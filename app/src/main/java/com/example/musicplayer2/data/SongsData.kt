...
import com.example.musicplayer2.data.base.AppDatabase
import com.example.musicplayer2.data.base.PlaylistSong
import com.example.musicplayer2.utils.PathUtils.getPathDown
import com.example.musicplayer2.utils.PathUtils.isSubDirOfAny
...
// Create random queue
    ...
    get() = if (!playingQueue.isNullOrEmpty() && playingQueueIndex in playingQueue!!.indices) {
        playingQueue!![playingQueueIndex]
    } else {
        null
    }
    ...
    private fun setRandomQueue() {
        ...
        songPlaying?.let { temporary.add(it) }
